...
static TSParseActionEntry ts_parse_actions[] = {
  ...
  [22] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_selectStmt, 6),
  ...
  [49] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_selectStmt, 7),
  [51] = {.entry = {.count = 1, .reusable = true}}, SHIFT(12),
  [53] = {.entry = {.count = 1, .reusable = true}}, SHIFT(18),
  [55] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_selectStmt_repeat1, 2), SHIFT_REPEAT(17),
  [58] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_selectStmt, 8),
  [60] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_step, 6),
  ...
  [78] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_stepVertexSet, 1),
  ...
  [86] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_stepEdgeSet, 1),
};
